...
import com.PhpTravels.Agentpages.AgentDashBoard;
...
public class AgentDashBoardTest extends TestBase1 {
	AgentLoginPage objLogin;
	AgentDashBoard objDash;
	@Test(priority = 0)
	...
	public void ValidCustomerDashBoard() throws IOException, InterruptedException {
		...
		objDash= new AgentDashBoard(driver);
